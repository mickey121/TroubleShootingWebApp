...
public class StepDisplayComponent extends Composite<Div> implements HasComponents {
...
//    private Button remove = new Button("Remove");
    ...
    public StepDisplayComponent(String arg) {
        this.name = arg;
    }

    public StepDisplayComponent(StepDto stepDto, MapperFactory mapperFactory) {
        binder = new Binder<>();
    ...
    public StepDisplayComponent(StepRepository stepRepository, MapperFactory mapperFactory) {
        binder = new Binder<>();
        currStep = new StepDto();
        infoLabel = new Label();
        stepName = new TextField();
    ...
    private void addForm() {
        ...
        txt = new TextField();
        stepFormLayout.addComponentAsFirst(txt);
        txt.setValue("initial txt value");
        stepFormLayout.addComponentAsFirst(new Label("Options"));
...
//            stepFormLayout.addComponentAsFirst(new Label("hi"));
            txt.setValue("value after click");
        });
